...
def deploy(img_path):
    ...
    net = caffe.Classifier('##REPLACE WITH ARCHITECTURE FILE##', '##REPLACE WITH WEIGHTS FILE##',
                           channel_swap=(2,1,0),
                           raw_scale=255,
                           image_dims=(256, 256))
    ...
    mean_image = caffe.io.load_image('##REPLACE WITH DATASET JOB DIRECTORY##/mean.jpg')
